...
eCommerce features in analytics platforms have as a core functionality to provide visibility on which products get the most attention from users, make it to the shopping basked and are as a result purchased more often. Even though this is feature is designed for ecommerce brands it can be applied in the context of subscription services or booking an appointment.
