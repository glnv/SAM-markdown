...
Another way of phrasing this can be found in Ben Horowitz' book "the hard thing about hard things" on page 124 even though he attributes the quote to Tony Robbins.

```md
“If you don’t know what you want, the chances that you’ll get it are extremely low.”
```

In other words — make sure you know what the client wants and help them articulate it.
